...
| TUI rendering | `internal/tui` pure render tests cover compact/wide layouts without terminal-specific APIs. | The same pure render tests apply because rendering is string based. | Launching the interactive Bubble Tea process remains unsupported. |
